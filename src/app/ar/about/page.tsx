...
export const metadata: Metadata = {
  title: "عن الموقع وسياسة التحقق | مرشد AI APIs",
    ...
    <div dir="rtl" className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="space-y-8 text-[#7d94b5] text-sm leading-relaxed">
        <section>
          ...
          <p>مرشد AI APIs هو دليل موجّه للمبتدئين يضم AI APIs الرسمية. هدفنا مساعدة المطورين الجدد في العثور على APIs موثوقة — مع معلومات صادقة عن الطبقات المجانية والأسعار ومستوى الصعوبة.</p>
        </section>
        <section>
        ...
        <section>
          ...
          <ul className="space-y-2">
            ...
            <li>• لا ندّعي أن أي API لديه وصول «مجاني غير محدود» ما لم تنص الوثائق الرسمية على ذلك بوضوح.</li>
