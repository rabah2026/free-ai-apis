    ...
    <div dir="rtl">
      ...
      <section className="relative py-24 sm:py-32 px-4 text-center overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-6xl font-bold text-white leading-tight tracking-tight mb-6" style={{ fontFamily: "system-ui, sans-serif" }}>
            واجهات الذكاء الاصطناعي المجانية،<br />موضّحة للمبتدئين.
          </h1>
          <p className="text-lg sm:text-xl text-[#7d94b5] leading-relaxed mb-10 max-w-2xl mx-auto">
            اكتشف واجهات الذكاء الاصطناعي الرسمية التي تقدم طبقات مجانية وأرصدة مجانية، مع توثيق واضح وأمثلة عملية وإرشادات صادقة للمبتدئين.
          </p>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-16">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-[#7d94b5] mt-1">واجهات برمجية مناسبة للمبتدئين مع خطط مجانية حقيقية</p>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-12 border-t border-[#1e2d45]">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-[#7d94b5] mt-1">كل ما تحتاج لفهم واجهات الذكاء الاصطناعي</p>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              { title: "لا مفاتيح غير رسمية", desc: "لا نرتبط أبدًا بمواقع «مفاتيح API مجانية» غير رسمية." },
            ].map((item) => (
      ...
      <section className="py-12 border-t border-[#1e2d45]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="bg-amber-950/30 border border-amber-900/50 rounded-2xl p-6">
            <h2 className="font-bold text-amber-300 text-lg mb-3">⚠️ تحذير: مواقع «مفاتيح API مجانية» غير الرسمية</h2>
            <p className="text-sm text-amber-200/80 leading-relaxed mb-4">
              هناك مواقع كثيرة تدّعي توفير مفاتيح API مجانية. هذه المواقع غير رسمية وقد تكون خطرة.
            </p>
            <ul className="space-y-2 text-sm text-amber-200/70">
              <li>• قد تسرق بيانات اعتمادك أو تحقن محتوى ضارًا في الردود.</li>
              <li>• قد تعمل المفاتيح بشكل مؤقت ثم تتوقف، مما يعطل تطبيقك.</li>
              <li>• استخدام المفاتيح غير الرسمية قد ينتهك شروط خدمة المزوّد.</li>
